        ...
        <Container maxWidth="lg">
          <Grid container spacing={5}>
            <Grid item xs={12} sm={4}>
              <Box  borderBottom={1} color="yellowgreen" > A propos de nous</Box>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <Box>
            ...
            <Grid item xs={12} sm={4}>
            <div className='titrefo' > <Box   borderBottom={1} color="yellowgreen">  Compte</Box></div>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <Box>
            ...
            <Grid item xs={12} sm={4}>
              <Box   borderBottom={1} color="yellowgreen"> Nous Sommes Sur</Box>
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <Box>
                  <Link href="/" color="inherit">
                    Facebook 
