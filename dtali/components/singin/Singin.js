...
const Singin = () => {
  ...
  const loginA =  (e) => {
    e.preventDefault(); 
    if(emailA ==='nazikessafi2001@gmail.com' && PasswordA === 'Jobstudent'){
...
<button onClick={handleClickOpen}> Administrateur</button>
  {popup?
    ...
    <div className='popup'>
    <div className="ff"><h2 onClick={closePopup}> <BsFillXOctagonFill /> </h2></div>
     <div className="mainA">
       <div>
         <div className="icons">
         ...
         <div>
          ...
          <button  onClick={loginA}>Login</button>
          </div>
